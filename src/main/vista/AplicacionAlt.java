...
public class AplicacionAlt extends Application {
    ...
    private DirectorioRecursos directorioRecursos = new DirectorioRecursos();
    ...
    public void start (Stage stage) throws Exception {
        ...
        GeneradorDeBotones generadorDeBotones = new GeneradorDeBotones(directorioRecursos.obtenerRecurso("fonts/Adventurer.ttf"));
        ...
        ImageView imagenFondo = new ImageView(directorioRecursos.obtenerRecurso("fondo.jpg"));

        ImageView imagenFondoMenu = new ImageView(directorioRecursos.obtenerRecurso("menufondo.png"));
        ...
        ImageView fondo_compra_piezas = new ImageView (directorioRecursos.obtenerRecurso("fondoCompraFichas.png"));
        ...
        ImageView imagenJinete = new ImageView((directorioRecursos.obtenerRecurso("jinete.png")));
        ImageView imagenSoldado = new ImageView((directorioRecursos.obtenerRecurso("soldado.png")));
        ImageView imagenCatapulta = new ImageView((directorioRecursos.obtenerRecurso("catapulta.png")));
        ImageView imagenCurandero = new ImageView((directorioRecursos.obtenerRecurso("curandero.png")));
        ...
        ImageView fondo_tablero1 = new ImageView (directorioRecursos.obtenerRecurso("fondo_tablero.png"));
        ...
        GeneradorCajaFichasRestantes generadorCajaFichasBlancasRestantes = new GeneradorCajaFichasRestantes(directorioRecursos.obtenerRecurso("fichasBlancas/"),ultimaPiezaSeleccionada, generadorDeEtiquetas);
        StackPane cajaFichasBlancasRestantes = null;

        GeneradorDeTablero generadorDeTablero = new GeneradorDeTablero ();
        GridPane tableroBlanco = generadorDeTablero.generarTablero(directorioRecursos.obtenerRecurso("escaqueBlanco40.png"),ultimaPiezaSeleccionada,juego,false);
        ...
        ImageView fondo_tablero2 = new ImageView (directorioRecursos.obtenerRecurso("fondo_tablero.png"));
        ...
        GeneradorCajaFichasRestantes generadorCajaFichasNegrasRestantes = new GeneradorCajaFichasRestantes(directorioRecursos.obtenerRecurso("fichasNegras/"),ultimaPiezaSeleccionada, generadorDeEtiquetas);

        GridPane tableroNegro = generadorDeTablero.generarTablero(directorioRecursos.obtenerRecurso("escaqueNegro40.png"),ultimaPiezaSeleccionada,juego,true);
        ...
        GeneradorDeCajaAtaqueMovimientoAlt generadorDeCajaAtaqueMovimiento = new GeneradorDeCajaAtaqueMovimientoAlt(directorio_resources);
        ...
        ImageView fondoDetallesPieza = new ImageView(directorioRecursos.obtenerRecurso("menuDetallesUnidad.png"));
