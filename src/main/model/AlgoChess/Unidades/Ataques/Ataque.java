...
public interface Ataque {
    ...
    void atacar (Unidad objetivo, Unidad atacante) throws CoordenadaFueraDeRangoExcepcion, ObjetivoFueraDeRangoExcepcion, NoSePudoCurarExcepcion, NoSePudoAtacarExcepcion;
